...
int isWin(int x, int y)
{
    ...
    if(flag % 2 == 0)
    {
        ...
        for(int k = 0;k < row_step.size();k++)
        {
            ...
            if(board[f_x][f_y] == 1 && inside(f_x,f_y))
            {
                count++;
            }
            else
        ...
        for(int k = 0;k < row_step.size();k++)
        {
            ...
            int f_x = x + row_step[k];
            int f_y = y + col_step[row_step.size() - k - 1];
            if(board[f_x][f_y] == 1 && inside(f_x,f_y))
            {
                count++;
            }
    ...
    else
    {
        ...
        for(int k = 0;k < row_step.size();k++)
        {
            ...
            int f_x = x + row_step[k];
            int f_y = y + col_step[k];
            if(board[f_x][f_y] == 2 && inside(f_x,f_y))
            {
                count++;
            }
            else
